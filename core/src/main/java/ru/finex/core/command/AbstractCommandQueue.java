...
/**
 * Класс, реализующий управление очередью команд.
 * Предоставляет логику для исполнения команд в виде входа в скоуп перед
 *  выполнением и выходом из скоупа после выполнения команды.
 * Каждая команда имеет свой скоуп, который определяется её контекстом.
 *
 * Pre-Commands всегда будут поставлены в начало очереди.
 *
